	...
	return (
		<div className='container mx-auto px-4 py-8'>
			...
			<div className='space-y-4'>
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					тўғрисида"ги{' '}
					<a href='/pdfs/1.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					<a href='/pdfs/2.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					<a href='/pdfs/3.pdf' className='text-blue-600 hover:text-blue-800'>
						205-сонли қарори
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					<a href='/pdfs/4' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					қўллаб-қувватлаш жамғармаси фаолиятини ташкил этиш тўғрисида"ги{' '}
					<a href='/pdfs/5.pdf' className='text-blue-600 hover:text-blue-800'>
						433-сонли қарори
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					таъсис этиш чора-тадбирлари тўғрисидаги"{' '}
					<a href='/pdfs/6.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					кўрсатишни такомиллаштиришнинг қўшимча чора-тадбирлари тўғрисида"ги{' '}
					<a href='/pdfs/7.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					доир чора-тадбирлар тўғрисида"ги{' '}
					<a href='/pdfs/8.pdf' className='text-blue-600 hover:text-blue-800'>
						1019-сонли қарори
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					<a href='/pdfs/9.pdf' className='text-blue-600 hover:text-blue-800'>
						14-сонли қарори
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					январдаги "Оилавий тадбиркорликни қўллаб-қувватлаш дастурлари
					доирасида боғдорчилик, узумчилик ва иссиқхона хўжалигини ривожлантириш
					чора-тадбирлари тўғрисида"ги{' '}
					<a href='/pdfs/10.pdf' className='text-blue-600 hover:text-blue-800'>
						52-сонли қарори
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					янада самарали фойдаланиш чора-тадбирлари тўғрисида"ги{' '}
					<a href='/pdfs/1.pdf' className='text-blue-600 hover:text-blue-800'>
						53-сонли қарори
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					тўғрисида"ги{' '}
					<a href='/pdfs/12.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					етиштириш ҳажмларини кўпайтириш чора-тадбирлар тўғрисида"ги{' '}
					<a href='/pdfs/13.pdf' className='text-blue-600 hover:text-blue-800'>
						216-сонли қарори
					</a>
				</span>

				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					14. Ўзбекистон Республикаси Президентининг 2020 йил 18 майдаги
					"Томорқа ер эгаларини қўллаб-қувватлаш ва аҳоли бандлигини таъминлаш
					бўйича қўшимча чора-тадбирлари тўғрисида"ги{' '}
					<a href='/pdfs/14.pdf' className='text-blue-600 hover:text-blue-800'>
						ПҚ-4716-сонли қарор
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					чора-тадбирлар тўғрсида"ги{' '}
					<a href='/pdfs/15.pdf' className='text-blue-600 hover:text-blue-800'>
						ПҚ-4767-сонли қарор
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					етиштириш ва экспорт қилишни кўпайтириш чора-тадбирлари тўғрисида"ги{' '}
					<a href='/pdfs/16.pdf' className='text-blue-600 hover:text-blue-800'>
						ПҚ-4863-сонли қарор
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					декабрдаги{' '}
					<a href='/pdfs/17.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					қўллаб-қувватлаш бўйича қўшимча чора-тадбирлар тўғрисида"ги{' '}
					<a href='/pdfs/18.pdf' className='text-blue-600 hover:text-blue-800'>
						ПҚ-4964-сонли қарор
					</a>
				</span>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					тўғрисида"ги{' '}
					<a href='/pdfs/19.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					тўғрисида"ги{' '}
					<a href='/pdfs/20.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					ҳисоблаш тўғрисида"ги{' '}
					<a href='/pdfs/21.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					чора-тадбирлари тўғрисида"ги{' '}
					<a href='/pdfs/22.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					қўшимча чора-тадбирлари тўғрисида"ги{' '}
					<a href='/pdfs/23.pdf' className='text-blue-600 hover:text-blue-800'>
				...
				<span className='block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow text-black'>
					...
					<a href='/pdfs/24.pdf' className='text-blue-600 hover:text-blue-800'>
